...
- [ ] 英文版（进行中）
  ...
  - [x] 目录表 343 条（PAGE 185 / VALUE 158），覆盖主页与设置页的大部分文案；
    替换加了中文边界断言，杜绝「不Available」这类中英混杂，
    并有「混杂守卫 + 覆盖率棘轮」两条测试（当前未翻译片段 230，最后一轮要求 0）。
  - [ ] 补齐主页/设置页剩余 230 个片段、CLI 约 347 条、API 文案约 300 条。
